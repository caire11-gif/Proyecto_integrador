<?php
/*if(empty($usuarioencargado)) {
    header("Location: ../login.html");
    exit;
}*/

date_default_timezone_set('America/Lima');
include('../../modelo/login/ingresarlogin.php');



$cod_usuario = $_SESSION['usuarioencargado'] ?? 'USU00';
...
<body>
            ...
            <div class="container-fluid py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn btn-success btn-sm" id="exportarexcel">
                            <i class="fas fa-file-excel me-1"></i>Exportar Excel
                        </button>
                        &nbsp;
                        <button class="btn btn-danger btn-sm" id="exportarpdf">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id="detallesEntrada">
                                                    <tr class="product-row">
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control precio-caja-input" name="precios_caja[]" value="0.00" step="0.01" min="0" required onchange="calcularTotalFila(this)" readonly>
                                                        </td>
                    ...
                    <div class="tab-pane fade <?php echo $tab_activa === 'historialEntradas' ? 'show active' : ''; ?>" id="historialEntradas">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0 text-center" id="tablaHistorial">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="descargarPDFCompra()">
    ...
    <script src="../../controlador/almacen/entradaproveedor/selechistorial.js"></script>
    <script src="../../controlador/almacen/entradaproveedor/exportarhis.js"></script>
    <script src="js/entradaproveedor/scripts.js"></script>
    <script>
